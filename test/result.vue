      ...
      <div id="zCl4FgIRl9">
          ...
          <div id="zbwOu2bRct">
              ...
              <el-select v-model="value" lc-mark placeholder="请选择" id="yhJlMNfb30">
                  <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value" id="JJvJ1iFxYQ"></el-option>
              </el-select>
          </div>
          <div id="YTa6ZVkK2O">
          ...
          <div id="7KI5xjoR7o">
              ...
              <el-time-select v-model="value5" lc-mark :picker-options="{ start: '08:30', step: '00:15', end: '18:30' }" placeholder="选择时间" id="tqTb7tAHV+"></el-time-select>
          </div>
          <div id="RLf1n2FDPv">
          ...
          <div id="6Jf5RcS8fq">
              ...
              <el-upload action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" multiple lc-mark :limit="3" :on-exceed="handleExceed" :file-list="fileList" id="ge2lt0HYLd">
...
用户头像上传:                  <el-upload class="avatar-uploader" action="https://jsonplaceholder.typicode.com/posts/" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
                      <img v-if="imageUrl" :src="imageUrl" class="avatar"/>                      <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                  </el-upload>
              </div>
              <div lc-mark style="max-width:400px;font-size:12px;">
图片列表缩略图:                  <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview" :on-remove="handleRemove" :file-list="fileList" list-type="picture">
...
export default {
  ...
  <style scoped lang="scss">.avatar-uploader ::v-deep .el-upload {
